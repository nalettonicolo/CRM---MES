...
- Gestione errori centralizzata (ProblemDetails), 134 test di integrazione API su database Sqlite in-memory isolato, CI su GitHub Actions (build + test a ogni push/PR).
